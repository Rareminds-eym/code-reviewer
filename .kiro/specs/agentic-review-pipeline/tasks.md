...
- [ ] 1. Foundation: shared types, feature flags, test tooling
...
- [ ] 2. Triage rules + types (shared edge/container)
...
- [ ] 4. Provenance types + Consensus router
...
- [ ] 5. Adapter tool-calling capability
...
- [ ] 6. Verification tools (read-only, sandboxed)
...
- [ ] 11. Tests: provenance + consensus router
...
- [ ] 12. Tests: verification tools sandbox
...
- [ ] 15. Wire container: schedule, finalize track, dependency audit, provenance tagging
...
- [ ] 16. Wire container: consensus router + verifier replacing Stage 2
...
- [ ] 18. Integration tests: disabled-equivalence + degradation matrix
...
- [ ] 19. Build, full test, and rollout notes
