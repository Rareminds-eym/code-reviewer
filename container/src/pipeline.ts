...
import type { Env, ReviewMessage } from './types/env.js';
...
export async function runReviewPipeline(
	...
	try {
		...
		const blastRadius = await buildBlastRadius(workDir, allowedFiles);
		...
		// ── Step 7: Deduplication and suppression ──
